 ...
 * @author BaZinGa
 */
public class ViewPreviousParticipants extends javax.swing.JPanel {

    /**
     * Creates new form ViewPreviousParticipants
     */
    public ViewPreviousParticipants() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, -1, 20));
        ...
        add(courseTypeComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 20, 165, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 790, -1));
    ...
    private void courseTypeComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseTypeComboBoxActionPerformed
        ...
        if(this.courseTypeComboBox.getSelectedIndex()!=0){
            switch (this.courseTypeComboBox.getSelectedIndex()) {
                case 1:
                    collectionName="YESPlusParticipantsList";
                    break;
                case 2:
                    collectionName="DSNParticipantsList";
                    break;
                case 3:            
                    collectionName="AdvanceMeditationProgramParticipantsList";
                    break;
                case 4:
                    collectionName="SahajSamadhiMeditationParticipantsList";
                    break;
                default:
                    break;
            }
            String column[]={"Name","Course ID","Date Of Course","Mobile no.","Amt. Paid"}; 
            ...
            try(MongoClient mongoClient=new MongoClient("localhost",27017)){
                ...
                try(DBCursor dBCursor=dbCollection.find()){
                    while(dBCursor.hasNext()){
                        ...
                        String date=dBObject.get("Date of Course").toString();
                        String courseID=dBObject.get("courseID").toString();
                        defaultTableModel.addRow(new Object[]{name,courseID,date,mobileNo,amountPaid});
                    }
                }
